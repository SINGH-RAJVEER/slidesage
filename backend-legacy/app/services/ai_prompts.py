...
Contains all system prompts, guides, and template strings for presentation generation.
"""
...
ITERATION_SYSTEM_PROMPT_TEMPLATE = """
...
def build_generation_prompt(detail_level: str = 'balanced', tonality: str = 'professional') -> str:
    """
    Build the system prompt for presentation generation.
    
    Args:
        detail_level: The level of detail for the presentation
        tonality: The tonality/style for the presentation
...
def build_iteration_prompt(detail_level: str = 'balanced', tonality: str = 'professional') -> str:
    """
    Build the system prompt for presentation iteration.
    ...
    return ITERATION_SYSTEM_PROMPT_TEMPLATE.format(
        detail_description=selected_detail['description'],
        detail_example=selected_detail['example'],
        tonality_description=selected_tonality['description'],
        tonality_example=selected_tonality['example'],
