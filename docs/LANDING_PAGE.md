...
- A sparse Canvas 2D star field remains behind the center. The shader paints immediately, pauses off-screen or in a hidden tab, and renders a static frame for reduced motion. The CSS fallback uses the same black surface and localized reflections.
