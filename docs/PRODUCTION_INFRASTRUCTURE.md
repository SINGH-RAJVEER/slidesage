...
- Cloud Run service `worker`, scaling from zero to ten request-owned River clients. Same-project Cloud Tasks reaches its default URL through internal ingress, and IAM grants invocation only to the runtime service account
